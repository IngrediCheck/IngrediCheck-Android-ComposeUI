                                ...
                                onClick = {
                                    scope.launch {
                                        when (val result = vm.submit(clientActivityId)) {
                                            is lc.fungee.IngrediCheck.data.repository.FeedbackSubmitResult.Success -> {
                                            ...
                                            is lc.fungee.IngrediCheck.data.repository.FeedbackSubmitResult.Unauthorized -> {
                                                vm.setError("Authentication required. Please sign in again.")
                                                onRequireReauth()
                                            }
                                            is lc.fungee.IngrediCheck.data.repository.FeedbackSubmitResult.Failure -> {
